...
//Buttons
	...
	AReg = new wxTextCtrl (this, -1, params[0].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AReg->SetMaxLength(2);
	wxStaticText* BLabel = new wxStaticText (this, -1, "B = ");
	BReg = new wxTextCtrl (this, -1, params[1].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	BReg->SetMaxLength(2);
	wxStaticText* CLabel = new wxStaticText (this, -1, "C = ");
	CReg = new wxTextCtrl (this, -1, params[2].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	CReg->SetMaxLength(2);
	wxStaticText* DLabel = new wxStaticText (this, -1, "D = ");
	DReg = new wxTextCtrl (this, -1, params[3].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	DReg->SetMaxLength(2);
	wxStaticText* ELabel = new wxStaticText (this, -1, "E = ");
	EReg = new wxTextCtrl (this, -1, params[4].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	EReg->SetMaxLength(2);
	wxStaticText* HLabel = new wxStaticText (this, -1, "H = ");
	HReg = new wxTextCtrl (this, -1, params[5].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	HReg->SetMaxLength(2);
	wxStaticText* LLabel = new wxStaticText (this, -1, "L = ");
	LReg = new wxTextCtrl (this, -1, params[6].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	LReg->SetMaxLength(2);
	
	wxSize* txtCtrlSize2Bytes = new wxSize(40, 20);
	
	wxStaticText* IXLabel = new wxStaticText (this, -1, "IX = ");
	IXReg = new wxTextCtrl (this, -1, params[7].c_str(), wxDefaultPosition, *txtCtrlSize2Bytes);
	IXReg->SetMaxLength(4);
	wxStaticText* IYLabel = new wxStaticText (this, -1, "IY = ");
	IYReg = new wxTextCtrl (this, -1, params[8].c_str(), wxDefaultPosition, *txtCtrlSize2Bytes);
	IYReg->SetMaxLength(4);

	wxStaticText* AltALabel = new wxStaticText (this, -1, "A' = ");
	AltAReg = new wxTextCtrl (this, -1, params[9].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AltAReg->SetMaxLength(2);
	wxStaticText* AltBLabel = new wxStaticText (this, -1, "B' = ");
	AltBReg = new wxTextCtrl (this, -1, params[10].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AltBReg->SetMaxLength(2);
	wxStaticText* AltCLabel = new wxStaticText (this, -1, "C' = ");
	AltCReg = new wxTextCtrl (this, -1, params[11].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AltCReg->SetMaxLength(2);
	wxStaticText* AltDLabel = new wxStaticText (this, -1, "D' = ");
	AltDReg = new wxTextCtrl (this, -1, params[12].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AltDReg->SetMaxLength(2);
	wxStaticText* AltELabel = new wxStaticText (this, -1, "E' = ");
	AltEReg = new wxTextCtrl (this, -1, params[13].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AltEReg->SetMaxLength(2);
	wxStaticText* AltHLabel = new wxStaticText (this, -1, "H' = ");
	AltHReg = new wxTextCtrl (this, -1, params[14].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AltHReg->SetMaxLength(2);
	wxStaticText* AltLLabel = new wxStaticText (this, -1, "L' = ");
	AltLReg = new wxTextCtrl (this, -1, params[15].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	AltLReg->SetMaxLength(2);
	
	
	wxStaticText* PCLabel = new wxStaticText (this, -1, "PC = ");
	PCReg = new wxTextCtrl (this, -1, params[28].c_str(), wxDefaultPosition, *txtCtrlSize2Bytes);
	PCReg->SetMaxLength(4);
	wxStaticText* SPLabel = new wxStaticText (this, -1, "SP = ");
	SPReg = new wxTextCtrl (this, -1, params[29].c_str(), wxDefaultPosition, *txtCtrlSize2Bytes);
	SPReg->SetMaxLength(4);
	wxStaticText* ILabel = new wxStaticText (this, -1, "I = ");
	IReg = new wxTextCtrl (this, -1, params[30].c_str(), wxDefaultPosition, *txtCtrlSize1Byte);
	IReg->SetMaxLength(2);
	...
	IMode = new wxComboBox (this, ID_IMBOX, params[31].c_str(), wxDefaultPosition, *dropDownSize, 3, IMChoices, wxCB_READONLY);
	wxStaticText* IFFLabel = new wxStaticText (this, -1, "IFF1 = ");
	IFFStatus = new wxComboBox (this, ID_IFFBOX, params[32].c_str(), wxDefaultPosition, *dropDownSize, 2, IFFChoices, wxCB_READONLY);
	...
	SFlag = new wxComboBox (this, -1, params[16].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* ZFlagLabel = new wxStaticText (this, -1, "Z = ");
	ZFlag = new wxComboBox (this, -1, params[17].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* HFlagLabel = new wxStaticText (this, -1, "H = ");
	HFlag = new wxComboBox (this, -1, params[18].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* PVFlagLabel = new wxStaticText (this, -1, "P/V = ");
	PVFlag = new wxComboBox (this, -1, params[19].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* NFlagLabel = new wxStaticText (this, -1, "N = ");
	NFlag = new wxComboBox (this, -1, params[20].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* CFlagLabel = new wxStaticText (this, -1, "C = ");
	CFlag = new wxComboBox (this, -1, params[21].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	
	//alternate flags
	wxStaticText* AltSFlagLabel = new wxStaticText (this, -1, "S' = ");
	AltSFlag = new wxComboBox (this, -1, params[22].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* AltZFlagLabel = new wxStaticText (this, -1, "Z' = ");
	AltZFlag = new wxComboBox (this, -1, params[23].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* AltHFlagLabel = new wxStaticText (this, -1, "H' = ");
	AltHFlag = new wxComboBox (this, -1, params[24].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* AltPVFlagLabel = new wxStaticText (this, -1, "P/V' = ");
	AltPVFlag = new wxComboBox (this, -1, params[25].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* AltNFlagLabel = new wxStaticText (this, -1, "N' = ");
	AltNFlag = new wxComboBox (this, -1, params[26].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
	wxStaticText* AltCFlagLabel = new wxStaticText (this, -1, "C' = ");
	AltCFlag = new wxComboBox (this, -1, params[27].c_str(), wxDefaultPosition, *flagDDSize, 2, FlagChoices, wxCB_READONLY);
...
void EditRegDialog::OnBtnSave( wxCommandEvent& event ){
	if (AReg->IsModified()) {
		ChangeRegValue(AReg, "A", AReg->GetLabel().c_str(), 2);
	}
	if (BReg->IsModified()) {
		ChangeRegValue(BReg, "B", BReg->GetLabel().c_str(), 2);
	}
	if (CReg->IsModified()) {
		ChangeRegValue(CReg, "C", CReg->GetLabel().c_str(), 2);
	}
	if (DReg->IsModified()) {
		ChangeRegValue(DReg, "D", DReg->GetLabel().c_str(), 2);
	}
	if (EReg->IsModified()) {
		ChangeRegValue(EReg, "E", EReg->GetLabel().c_str(), 2);
	}
	if (HReg->IsModified()) {
		ChangeRegValue(HReg, "H", HReg->GetLabel().c_str(), 2);
	}
	if (LReg->IsModified()) {
		ChangeRegValue(LReg, "L", LReg->GetLabel().c_str(), 2);
	}
	if (IXReg->IsModified()) {
		ChangeRegValue(IXReg, "IX", IXReg->GetLabel().c_str(), 4);
	}
	if (IYReg->IsModified()) {
		ChangeRegValue(IYReg, "IY", IYReg->GetLabel().c_str(), 4);
	}
	if (AltAReg->IsModified()) {
		ChangeRegValue(AltAReg, "A'", AltAReg->GetLabel().c_str(), 2);
	}
	if (AltBReg->IsModified()) {
		ChangeRegValue(AltBReg, "B'", AltBReg->GetLabel().c_str(), 2);
	}
	if (AltCReg->IsModified()) {
		ChangeRegValue(AltCReg, "C'", AltCReg->GetLabel().c_str(), 2);
	}
	if (AltDReg->IsModified()) {
		ChangeRegValue(AltDReg, "D'", AltDReg->GetLabel().c_str(), 2);
	}
	if (AltEReg->IsModified()) {
		ChangeRegValue(AltEReg, "E'", AltEReg->GetLabel().c_str(), 2);
	}
	if (AltHReg->IsModified()) {
		ChangeRegValue(AltHReg, "H'", AltHReg->GetLabel().c_str(), 2);
	}
	if (AltLReg->IsModified()) {
		ChangeRegValue(AltLReg, "L'", AltLReg->GetLabel().c_str(), 2);
	}
	if (PCReg->IsModified()) {
		ChangeRegValue(PCReg, "PC", PCReg->GetLabel().c_str(), 4);
	}
	if (SPReg->IsModified()) {
		ChangeRegValue(SPReg, "SP", SPReg->GetLabel().c_str(), 4);
	}
	if (IReg->IsModified()) {
		ChangeRegValue(IReg, "I", IReg->GetLabel().c_str(), 2);
	}
	...
	if (IFFStatus->GetValue().c_str() == "Disabled") {
		RegVal = "0";
		change = true;
	}
	else if (IFFStatus->GetValue().c_str() == "Enabled") {
		RegVal = "1";
		change = true;
	}
	else {
